...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
	...
	$md = base64_encode(strtolower($Pword));	
	
}
if ($_SERVER["REQUEST_METHOD"] === "POST"){

	$Pword = trim(isset($_POST['word']) ? strtolower($_POST['word']) : null );
	$md1 = base64_decode($md);	
                            ...
                            <div class="user-wrapper bg-dark">
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="list-unstyled user-info">
                                        ...
                                        <li>Last Access : <br>
                                            <small><i class="fa fa-calendar"></i>&nbsp;14 April 16:32</small>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<body><br /><br/>
<div class="conrainer">
	<form action="base64.php" method="POST" name="library">
		<div class="">
			<label for="word">String</label>
			<input type="text" name="word" placeholder="Enter String.." />
		</div>
		<div class="">
	...
	<?php 
		if($_POST){
			...
			if($Pword != null || $Pword != ""){			
			echo "Base64 Encoding  for string ". $Pword. " is   " . $md ;	
			}
		}
	 ?>
 <br /> <br />
<div class="container">
	...
	<form action="base64.php" method="GET" name="library">
		<div class="">
			<label for="md5">Base64 Decoding:</label>
			<input type="text" name="sha" placeholder="Enter encoding string" />
		</div>
		<div class="">
			<button type="submit">Check Decoding</button>
		</div>
	</form>
</div>
	<?php 
		if($_POST){
			...
			if($Pword != null || $Pword != ""){			
			echo "Base64 Decoding  for string ". $md. " is   " . $md1 ;	
			}
		}
	 ?>
