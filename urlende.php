...
<body><br /><br/>
<div class="conrainer">
	<form action="urlende.php" method="POST" name="library">
		<div class="">
	...
	<?php 
		if($_POST){
			...
			if($Pword != null || $Pword != ""){			
			echo "URL Encoding  for string ". $Pword. " is   " . $md ;	
			}
		}
	 ?>
 <br /> <br />
<div class="container">
	...
	<form action="urlende.php" method="GET" name="library">
		<div class="">
			<label for="md5">URL Decoding:</label>
